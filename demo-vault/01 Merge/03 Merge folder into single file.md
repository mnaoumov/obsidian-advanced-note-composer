...
nested `Nested` folder becomes a `# Nested` heading in the merged note, and [Part 2](<../Materials/03 Merge folder into single file/Merge into single file/Nested/Part 2.md>)'s own headings
...
[13 Split headings recursively](<../03 Split/13 Split headings recursively.md>)): split a note into a folder
...
[`Merge current folder with another folder...`](<../01 Merge/02 Merge folder.md>): a drawing is moved into the
