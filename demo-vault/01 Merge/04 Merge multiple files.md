...
2. Select more than one note - for example [Note A](<../Materials/04 Merge multiple files/Merge multiple files/Note A.md>) and [Note B](<../Materials/04 Merge multiple files/Merge multiple files/Note B.md>) (Ctrl/Cmd-click, or Shift-click a
   range).
...
[Note A](<../Materials/04 Merge multiple files/Merge multiple files/Note A.md>) and [Note B](<../Materials/04 Merge multiple files/Merge multiple files/Note B.md>) are merged, in order, into [Combined](<../Materials/04 Merge multiple files/Merge multiple files/Combined.md>) and then deleted. Each note runs
