...
combined using your **Frontmatter merge strategy** (see [30 Frontmatter merge strategy](<../09 Titles, links and frontmatter/30 Frontmatter merge strategy.md>)).
...
[`Merge these files into one file...`](<../01 Merge/04 Merge multiple files.md>) too.
