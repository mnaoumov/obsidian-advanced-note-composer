...
[20 Flatten folder](<../06 Folder operations/20 Flatten folder.md>),
[03 Merge folder into single file](<../01 Merge/03 Merge folder into single file.md>),
[13 Split headings recursively](<../03 Split/13 Split headings recursively.md>),
[22 Create folder with notes](<../06 Folder operations/22 Create folder with notes.md>) and
...
[32 Minimizing dialogs](<../10 UI/32 Minimizing dialogs.md>).
