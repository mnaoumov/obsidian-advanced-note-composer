...
[22 Create folder with notes](<../06 Folder operations/22 Create folder with notes.md>) already writes, so a folder created
...
[ignored](<../08 Include and exclude/26 Block commands on excluded paths.md>) is refused with a notice, and the vault root is
