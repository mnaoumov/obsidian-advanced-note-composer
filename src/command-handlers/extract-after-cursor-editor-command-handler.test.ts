...
describe('ExtractAfterCursorEditorCommandHandler viewport menu placement', () => {
  it('should stay off the readable-line-length margin while the category is placed in the editor menu', () => {
    const handler = toTestable(new ExtractAfterCursorEditorCommandHandler(createMockParams()));
